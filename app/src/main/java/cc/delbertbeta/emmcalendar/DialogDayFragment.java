 ...
 * {@link DialogDayFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DialogDayFragment#newInstance} factory method to
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.right_arrow).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((ViewPager)getParentFragment().getView().findViewById(R.id.dialog_view_pager)).setCurrentItem(1);
            }
        });
        return view;
    }
